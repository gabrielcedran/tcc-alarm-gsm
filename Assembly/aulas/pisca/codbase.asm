...
;RODRIGO DOS REIS ROCHA			RA:0805500
...
; ******************************************************************************
    ...
    CBLOCK 0X20                		;0X20 É O INÍCIO DA MEMÓRIA RAM
		...
		AUX_E
    ENDC
    #DEFINE 	BTN_D PORTA,1        ;DEFINE QUE BTN_D = PORTA,0
    #DEFINE	BTN_E PORTA,0	     ;DEFINE QUE BTN_E = PORTA,1 
...
INICIO
    ...
    MOVLW   B'00000011'				;0=SAÍDA    1=ENTRADA
